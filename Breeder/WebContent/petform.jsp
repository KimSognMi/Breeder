			...
			<section id="two">
				...
				<div class="col-md-6 col-md-offset-3">
					...
					<form action="PetAddServlet" method="post"
						...
						<div class="field2">
							<h5>kkc 등록번호</h5>
							<input type="text" class="form-control" name="p_kkcnumber"
								id="p_kkcnumber" placeholder="입력해 주세요">
						</div>
						...
						<div class="field3 ">
							<!-- <label for="passwd2">비밀번호 확인</label> -->
							<h5>모견 KKCNumber</span></h5>
							 <input
								type="text" class="form-control" name="mom_kkc" id="mom_kkc"
								placeholder="모견 KKCNumber">
							
						</div>
						
						<div class="field3 ">
							<!-- <label for="passwd2">비밀번호 확인</label> -->
							<h5>부견 KKCNumber</span></h5>
							 <input
								type="text" class="form-control" name="papa_kkc" id="papa_kkc"
								placeholder="부견 KKCNumber">
